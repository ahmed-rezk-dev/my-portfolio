...
const subInfoText = (
	<p>
		...
		out my about page! 👉🏼<Link href="/about"> Here!</Link>
	</p>
)

const resume =
	"https://www.icloud.com/iclouddrive/0cf44EExxTVRXT-yas5lRpYUA#Ahmed_Rezk_Resume"
			...
			<Row className="align-items-center mt-md-5">
				<Col md={6} xs={{ span: 12, order: 2 }} className="mt-2">
					<Col md={12} className="mt-4">
						<DevInfo className="mb-5" element={infoText} />
				...
				>
					<Image
						...
						thumbnail
						alt="Ahmed Rezk"
						className={!isLightTheme ? "dark-image" : ""}
					/>
					...
					<Button
						...
						href={resume}
						target="_blank"
						// TODO: Check whats is the download link for
						// download
					>
						Download Resume
					</Button>
